...
# url="https://results.us.securityeducation.com/api/reporting/v0.1.0/auhentication"
# # url4=  "https://results.us.securityeducation.com/api/reporting/v0.1.0/users
...
dino_data_clean = [links_and_names[link] for link in range(len(links_and_names)) if
                   links_and_names[link][0].startswith("/wiki/")]
...
dino_df: Any = pd.concat([dino_df, dino_details], ignore_index=True, axis=1)

file_name = r'C:/Users/sraym/Documents/dimo/dino-data.xlsx'
#
...
#
# """Ok, from this point I will comment everything in above so I don't have to scrap and I will create a new DataFrame from the excel file I create, this way everything will be we much more fast"""
#
...
for element in dino_info:
    if re.findall(r'\d+\smeters', str(element)):
        height = re.findall(r'\d+\smeters', str(element))
